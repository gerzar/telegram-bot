...
use App\Commands\AddWordAICommand;
use App\Commands\AddWordCommand;
use App\Commands\StartCommand;
use App\Commands\TranslateCommand;
use App\Commands\UnlearnedWordsCommand;
use App\Commands\UserSettingsCommand;
...
return [
    ...
    */
    'bots' => [
        'mybot' => [
            'token' => env('TELEGRAM_BOT_TOKEN', '7596243534:AAFAyTcpgm-ahlxLooRRM47TRhL1nWs1lCs'),
            'username' => env('TELEGRAM_BOT_USERNAME', '@easyenglishcarsbot'),
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url' => env('TELEGRAM_WEBHOOK_URL', ' https://60f9-45-128-133-227.ngrok-free.app/api/telegram/webhook'),
            /*
            ...
            'commands' => [
                ...
                UnlearnedWordsCommand::class,
                WordRepeaterCommand::class,
                AddWordAICommand::class,
